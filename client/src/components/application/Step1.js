...
export default class Step1 extends Component {
  ...
  render() {
    ...
    //Name
    if (typeof this.state.nameVal == "text" || this.state.nameVal) {
    ...
    //Name of Parent
    if (
      typeof this.state.nameOfParentVal == "text" ||
    ...
    //Gender
    if (typeof this.state.genderVal == "select" || this.state.genderVal) {
    ...
    //Date Of Birth
    if (
      typeof this.state.dateOfBirthVal == "date" ||
    ...
    //citizenship
    if (
      typeof this.state.citizenshipVal == "text" ||
    ...
    //Nativity
    if (typeof this.state.nativityVal == "text" || this.state.nativityVal) {
    ...
    //Place Of Birth
    if (
      typeof this.state.placeOfBirthVal == "text" ||
    ...
    //Religion
    if (typeof this.state.religionVal == "text" || this.state.religionVal) {
    ...
    //Mother Tongue
    if (
      typeof this.state.motherTongueVal == "text" ||
