    ...
    if (
      ...
      return (
        <tbody>
          ...
          <tr>
            <th scope="row">I</th>
            <td name="IsemMonth">{`${this.props.getStore().IsemMonth}`}</td>
            <td name="Isemyop">{`${this.props.getStore().Isemyop}`}</td>
            <td name="Isemmaxmarks">{`${
              this.props.getStore().Isemmaxmarks
            }`}</td>
            <td name="Isemmarks">{`${this.props.getStore().Isemmarks}`}</td>
          </tr>
          <tr>
            <th scope="row">II</th>
            <td name="IIsemMonth">{`${this.props.getStore().IIsemMonth}`}</td>
            <td name="IIsemyop">{`${this.props.getStore().IIsemyop}`}</td>
            <td name="IIsemmaxmarks">{`${
              this.props.getStore().IIsemmaxmarks
            }`}</td>
            <td name="IIsemmarks">{`${this.props.getStore().IIsemmarks}`}</td>
          </tr>
          <tr>
            <th scope="row">III</th>
            <td name="IIIsemMonth">{`${this.props.getStore().IIIsemMonth}`}</td>
            <td name="IIIsemyop">{`${this.props.getStore().IIIsemyop}`}</td>
            <td name="IIIsemmaxmarks">{`${
              this.props.getStore().IIIsemmaxmarks
            }`}</td>
            <td name="IIIsemmarks">{`${this.props.getStore().IIIsemmarks}`}</td>
          </tr>
          <tr>
            <th scope="row">IV</th>
            <td name="IVsemMonth">{`${this.props.getStore().IVsemMonth}`}</td>
            <td name="IVsemyop">{`${this.props.getStore().IVsemyop}`}</td>
            <td name="IVsemmaxmarks">{`${
              this.props.getStore().IVsemmaxmarks
            }`}</td>
            <td name="IVsemmarks">{`${this.props.getStore().IVsemmarks}`}</td>
          </tr>
          <tr>
            <th scope="row">V</th>
            <td name="VsemMonth">{`${this.props.getStore().VsemMonth}`}</td>
            <td name="Vsemyop">{`${this.props.getStore().Vsemyop}`}</td>
            <td name="Vsemmaxmarks">{`${
              this.props.getStore().Vsemmaxmarks
            }`}</td>
            <td name="Vsemmarks">{`${this.props.getStore().Vsemmarks}`}</td>
          </tr>
          <tr>
            <th scope="row">VI</th>
            <td name="VIsemMonth">{`${this.props.getStore().VIsemMonth}`}</td>
            <td name="VIsemyop">{`${this.props.getStore().VIsemyop}`}</td>
            <td name="VIsemmaxmarks">{`${
              this.props.getStore().VIsemmaxmarks
            }`}</td>
            <td name="VIsemmarks">{`${this.props.getStore().VIsemmarks}`}</td>
          </tr>
        </tbody>
      );
    } else if (
      ...
      return (
        <tbody>
          ...
          <tr>
            <th scope="row">VII</th>
            <td name="VIIsemMonth">{`${this.props.getStore().VIIsemMonth}`}</td>
            <td name="VIIsemyop">{`${this.props.getStore().VIIsemyop}`}</td>
            <td name="VIIsemmaxmarks">{`${
              this.props.getStore().VIIsemmaxmarks
            }`}</td>
            <td name="VIIsemmarks">{`${this.props.getStore().VIIsemmarks}`}</td>
          </tr>
          <tr>
            ...
            <td name="VIIIsemyop">{`${this.props.getStore().VIIIsemyop}`}</td>
          ...
          <tr>
            <th scope="row">IX</th>
            <td name="IXsemMonth">{`${this.props.getStore().IXsemMonth}`}</td>
            <td name="IXsemyop">{`${this.props.getStore().IXsemyop}`}</td>
            <td name="IXsemmaxmarks">{`${
              this.props.getStore().IXsemmaxmarks
            }`}</td>
            <td name="IXsemmarks">{`${this.props.getStore().IXsemmarks}`}</td>
          </tr>
          <tr>
            <th scope="row">X</th>
            <td name="XsemMonth">{`${this.props.getStore().XsemMonth}`}</td>
            <td name="Xsemyop">{`${this.props.getStore().Xsemyop}`}</td>
            <td name="Xsemmaxmarks">{`${
              this.props.getStore().Xsemmaxmarks
            }`}</td>
            <td name="Xsemmarks">{`${this.props.getStore().Xsemmarks}`}</td>
          </tr>
        </tbody>
      );
    } else if (
            ...
            <Table bordered>
              <tbody>
                ...
                <tr>
                  ...
                  <td name="email">{`${this.props.getStore().email}`}</td>
                </tr>
                <tr></tr>
                <tr></tr>
              </tbody>
