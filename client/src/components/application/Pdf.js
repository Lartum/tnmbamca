          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              <View style={styles.tableCol5}>
                <Text style={styles.tableCell2}>{this.state.users.prefinalsemoverallmarksobtained}</Text>
              </View>
              <View style={styles.tableCol5}>
                <Text style={styles.tableCell2}>{this.state.users.prefinalsemoveralltotalmarks}</Text>
              </View>
              <View style={styles.tableCol5}>
...
11.Sri Lankan Refugee Certificate - IF Applicable.
    ...
    if (this.state.users !== null && this.state.image !== null) {
     ...
     if(this.state.users.patternOfStudy === "10 + 3 Years Diploma + 3 Years Degree" ){
