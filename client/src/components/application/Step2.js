  ...
  render() {
    ...
    return (
      <div className="step step2">
        <Card>
          <CardHeader><h3 style={{textAlign:"center",color:'limegreen'}}>ADDRESS DETAILS</h3></CardHeader>
          <CardBody>
            <Row form>
              <Col md={6}>
                <FormGroup>
        ...
        <Card>
        <CardHeader><h3 style={{textAlign:"center",color:'limegreen'}}>CONTACT DETAILS</h3></CardHeader>
          <CardBody>
            <Row form>
              <Col md={6}>
                <FormGroup>
